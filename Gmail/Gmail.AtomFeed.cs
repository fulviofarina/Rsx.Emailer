...
namespace Rsx
{
    public static partial class Gmail
    {
        ...
        public class AtomFeed
        {
            ...
            /// <summary>
            /// Constructor, creates the gmail atom feed object. <note> Creating the object does not
            /// get the feed, the <c>GetFeed</c> method must be called to get the current feed. </note>
            /// </summary>
            /// <param name="gmailUserName">
            /// The username of the gmail account that the message will be sent through
            /// </param>
            /// <param name="gmailPassword">
            /// The password of the gmail account that the message will be sent through
            /// </param>
            public AtomFeed(string gmailUserName, string gmailPassword)
            {
            ...
            /// <summary>
            /// Gets the current atom feed for the specified account and loads all properties and
            /// collections with the feed data. Any existing data will be replaced by the new feed.
            /// <note> If the <c>FeedLabel</c> property equals <c>string.Empty</c> the feed for the
            /// inbox will be retreived. </note>
            /// </summary>
            public void GetFeed()
            {
                ...
                NetworkCredential credentials = new NetworkCredential(this.GmailUserName, this.GmailPassword);
            ...
            public class AtomFeedEntryCollection : System.Collections.CollectionBase
            {
                ...
                /// <summary>
                /// Returns the position of the first of the <c>AtomFeedEntry</c> object. If it is
                /// not found then <c>-1</c> is returned.
                /// </summary>
                /// <param name="feedEntry"><c>AtomFeedEntry</c> to find</param>
                /// <returns></returns>
