...
namespace Rsx
{
    ...
    {
        /// <summary>
        /// Provides a message object that sends the email through gmail. GmailMessage is inherited
        /// from <c>System.Web.Mail.MailMessage</c>, so all the mail message features are available.
        /// </summary>
        public class Message : System.Web.Mail.MailMessage
        {
            ...
            /// </param>
            public Message(string gmailUserName, string gmailPassword)
            {
                this.Fields[SMTP_SERVER] = Message.GmailServer;
                this.Fields[SMTP_SERVER_PORT] = Message.GmailServerPort;
            ...
            public static void SendMailMessageFromGmail(string gmailUserName, string gmailPassword, System.Web.Mail.MailMessage message)
            {
                try
                {
                    message.Fields[SMTP_SERVER] = Message.GmailServer;
                    message.Fields[SMTP_SERVER_PORT] = Message.GmailServerPort;
            ...
            public static void SendFromGmail(string gmailUserName, string gmailPassword, string toAddress, string subject, string messageBody)
            {
                try
                {
                    Message gMessage = new Message(gmailUserName, gmailPassword);
