...
namespace Rsx
{
    ...
    {
        /// <summary>
        /// Gets the list of commands stored in the gmailFeed since the given input time and labeled
        /// under the given filter
        /// </summary>
        /// <param name="since">    Start Datetime to filter the list of commands</param>
        /// <param name="gmailFeed">feed to read data from</param>
        /// <param name="filter">   
        /// The commands to look for should start with the given filter string
        /// </param>
        /// <returns></returns>
